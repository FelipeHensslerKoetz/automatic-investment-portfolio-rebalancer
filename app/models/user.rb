...
class User < ApplicationRecord
  ...
  has_many :automatic_rebalance_options, through: :investment_portfolios
  has_many :investment_portfolio_rebalance_notification_options, through: :investment_portfolios
end
