...
RSpec.describe InvestmentPortfolio, type: :model do
  describe 'associations' do
    ...
    it { should have_many(:investment_portfolio_rebalance_notification_options).dependent(:restrict_with_error) }
    it { should have_many(:investment_portfolio_rebalance_notification_orders).dependent(:restrict_with_error) }
  end
