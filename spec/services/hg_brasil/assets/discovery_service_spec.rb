...
RSpec.describe HgBrasil::Assets::DiscoveryService do
  ...
  context 'when ticker_symbol exists' do
    context 'when ticker_symbol is a stock' do
      ...
      it 'creates a new Asset and AssetPrice' do
        VCR.use_cassette('hg_brasil_assets/asset_discovery_success') do
          ...
          expect(asset_price.partner_resource.name).to eq('HG Brasil - Assets')
    ...
    context 'when ticker_symbol is a fii' do
      ...
      it 'creates a new Asset and AssetPrice' do
        VCR.use_cassette('hg_brasil_assets/asset_discovery_fii_success') do
          new_asset = hg_brasil_asset_discovery
    ...
    context 'when ticker_symbol is an ETF' do
      ...
      it 'creates a new Asset and AssetPrice' do
        VCR.use_cassette('hg_brasil_assets/asset_discovery_etf_success') do
          new_asset = hg_brasil_asset_discovery
  ...
  context 'when ticker_symbol does not exists' do
    ...
    it 'returns nil' do
      VCR.use_cassette('hg_brasil_assets/asset_discovery_not_found') do
  ...
  context 'when request fails' do
    ...
    it 'returns nil' do
      VCR.use_cassette('hg_brasil_assets/asset_discovery_error') do
