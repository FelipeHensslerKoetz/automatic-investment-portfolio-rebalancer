...
class UserMailerPreview < ActionMailer::Preview
  def rebalance_notification_email 
    ...
    rebalance.update(
      current_investment_portfolio_state: [{"price"=>"38.69",
      ...
      "current_variation_percentage"=>"3.1832750582750582750582750582750583",
     ...
     {"price"=>"61.12",
      ...
      "current_variation_percentage"=>"19.5221445221445221445221445221445221",
      "currency_parity_exchange_rate"=>nil,
      "target_variation_limit_percentage"=>"0.0",
      "target_allocation_weight_percentage"=>"25.0",
     ...
     {"price"=>"27.11",
      ...
      "current_variation_percentage"=>"-5.252039627039627039627039627039627",
      "currency_parity_exchange_rate"=>nil,
      "target_variation_limit_percentage"=>"0.0",
      "target_allocation_weight_percentage"=>"25.0",
     ...
     {"price"=>"10.36",
      ...
      "current_variation_percentage"=>"-17.4533799533799533799533799533799534",
      "currency_parity_exchange_rate"=>nil,
      "target_variation_limit_percentage"=>"0.0",
      "target_allocation_weight_percentage"=>"25.0",
      "current_allocation_weight_percentage"=>"7.5466200466200466200466200466200466"}],
      projected_investment_portfolio_state_with_rebalance_actions: [{"price"=>"38.69",
      "currency"=>{"id"=>3, "code"=>"BRL", "name"=>"Brazilian Real", "created_at"=>"2024-07-08T18:06:29.034Z", "updated_at"=>"2024-07-08T18:06:29.034Z"},
      ...
      "current_variation_percentage"=>"0.0000000000000000000000000000000000000923659673659673659673659673659673659673659673659674",
      "currency_parity_exchange_rate"=>nil,
      "target_variation_limit_percentage"=>"0.0",
      "target_allocation_weight_percentage"=>"25.0",
     ...
     {"price"=>"61.12",
      ...
      "quantity_adjustment"=>"0.0",
      "current_variation_percentage"=>"0.0000000000000000000000000000000000001048951048951048951048951048951048951048951048951049",
      "currency_parity_exchange_rate"=>nil,
      "target_variation_limit_percentage"=>"0.0",
      "target_allocation_weight_percentage"=>"25.0",
     ...
     {"price"=>"27.11",
      ...
      "quantity_adjustment"=>"0.0",
      "current_variation_percentage"=>"0.0000000000000000000000000000000000000536858974358974358974358974358974358974358974358974",
      "currency_parity_exchange_rate"=>nil,
      "target_variation_limit_percentage"=>"0.0",
      "target_allocation_weight_percentage"=>"25.0",
     ...
     {"price"=>"10.36",
      ...
      "quantity_adjustment"=>"0.0",
      "current_variation_percentage"=>"-0.0000000000000000000000000000000000000206876456876456876456876456876456876456876456876457",
      "currency_parity_exchange_rate"=>nil,
      "target_variation_limit_percentage"=>"0.0",
      "target_allocation_weight_percentage"=>"25.0",
